...
namespace SMaths
{
    ...
    public struct SRange
    {
        ...
        public float MaxClampAddition(float addition)
        {
            float value = minValue + addition;
            return (value > maxValue) ? maxValue : value;
        }

        public float MinClampSubtraction(float subtraction)
        {
            float value = maxValue - subtraction;
