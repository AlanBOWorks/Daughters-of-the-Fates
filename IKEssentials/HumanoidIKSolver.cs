...
namespace IKEssentials
{
    ...
    {
        public HumanoidIKSolver(FullBodyBipedIK biped, LookAtIK headLookAt, IrisLookAt irisLookAt, bool isLeftMain = false)
        {
    ...
    public class HeadLookAtSolver : IHeadIKSolver
    {
        ...
        public HeadLookAtSolver(LookAtIK headLookAt, IrisLookAt irisLookAt)
        {
        ...
        {
            HeadLookAt.IKPositionWeight = weight;
        }

        public float GetHeadWeight()
        {
            return HeadLookAt.IKPositionWeight;
        }

        public Vector3 GetHeadLookPoint()
        {
            return HeadLookAt.IKPosition;
        }
